...
# AttentionModel继承了Model类，重写了_build_decoder_cell方法
class AttentionModel(model.Model):
  ...
  def _build_decoder_cell(self, hparams, encoder_outputs, encoder_state,
    ...
    # 这里使用了model_helper.py里的create_rnn_cell()
    ...
    alignment_history = (self.mode == tf.contrib.learn.ModeKeys.INFER and
                         infer_mode != "beam_search")
    # 添加了attention_mechanism
    # 对原先的 decoder_cell 用 tf.contrib.seq2seq.AttentionWrapper 来包裹解码单元
    # 得到的新的 decoder cell 会自动具有注意力机制
